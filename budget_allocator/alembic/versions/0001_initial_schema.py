...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("event_type",
                  postgresql.ENUM(name="auth_event_type", create_type=False),
                  nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  postgresql.ENUM(name="family_status", create_type=False),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  postgresql.ENUM(name="team_status", create_type=False),
    ...
    op.create_table(
        ...
        sa.Column("action",
                  postgresql.ENUM(name="admin_action_type", create_type=False),
                  nullable=False),
